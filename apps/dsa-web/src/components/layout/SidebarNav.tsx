...
import { BarChart3, Bell, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Search, Settings2, Logs } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'logs', labelKey: 'layout.nav.logs', to: '/logs', icon: Logs },
];
